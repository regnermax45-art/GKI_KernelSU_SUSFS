...
class ToolsConfig:
    ...
    zip_path: str = "7z"  # This will map from 7zip_path in JSON
...
class KitchenConfig:
    ...
    def _create_config_objects(self):
        ...
        try:
            ...
            # Map 7zip_path to zip_path for compatibility
            if "7zip_path" in tools_data:
                tools_data["zip_path"] = tools_data.pop("7zip_path")
